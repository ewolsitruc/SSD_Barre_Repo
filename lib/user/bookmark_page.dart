            ...
            Expanded(
              child: StreamBuilder<DocumentSnapshot>(
                ...
                builder: (context, userSnapshot) {
                  ...
                  // Fixed: Explicitly cast to Map<String, dynamic> before accessing keys
                  final userDataMap = userSnapshot.data!.data() as Map<String, dynamic>?;
                  final List<dynamic> bookmarkedPostIds = userDataMap?['bookmarks'] ?? [];
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final String formattedDate = createdAt != null ?
                              DateFormat('MMM dd,ญี่ป� \'at\' hh:mm a').format(createdAt.toDate())
                              : 'Unknown Date';
